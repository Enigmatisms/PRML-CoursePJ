...
CUDA_VISIBLE_DEVICES=0 python3 ./train_swin.py --atcg_len 1000 --adam_wdecay 1e-3 \
    --lr_max_start 5e-4 --lr_max_end 5e-5 --lr_min_start 1e-4 --lr_min_end 2e-5 \
    --pos_threshold 0.5 --emb_dropout 0.1 --path_dropout 0.2 --class_dropout 0.1 \
    --batch_size 100 --test_batch_size 100 --test_batches 30 --train_eval_time 5 \
    --train_verbose 100 --seed 3407 --mixup 0.25 --mixup_epochs 300
